...
//   viewing, editing, saving, and deleting house records.
//
// OOP CONCEPT: CRUD Pattern (Create, Read, Update, Delete)
//   This module implements three of the four CRUD operations:
//   - READ: openSidebar() fetches and displays house data
//   - UPDATE: saveSidebar() writes modified data back to Supabase
//   - DELETE: deleteSidebar() removes a house record
//   (CREATE is handled by openHouseModal in mts-app.js)
//
// OOP CONCEPT: MVC Architecture (Model-View-Controller)
//   - MODEL: House data in state.houses[] and Supabase database
//   - VIEW: HTML form generated by openSidebar() (dynamic DOM)
//   - CONTROLLER: Event handlers that mediate between user actions
//     and data operations (save, delete, photo upload, etc.)
//
// OOP CONCEPT: Encapsulation (Form State)
//   The sidebar manages its own internal dirty state (state.sidebarDirty).
//   This ENCAPSULATES the concept of "unsaved changes" - other modules
//   query this flag but don't modify it directly.
//
// WEB SCIENCE: RESTful Data Operations
//   - UPDATE: Supabase .update() sends an HTTP PATCH request
//   - DELETE: Supabase .delete() sends an HTTP DELETE request
//   Both operations are IDEMPOTENT - repeating them has no additional effect.
//
// WEB SCIENCE: File Upload (Supabase Storage)
//   Photo uploads use Supabase Storage, which accepts binary data via
//   HTTP POST (multipart/form-data equivalent). Files are stored in a
//   cloud bucket and accessed via public URLs. The resizeImage() function
//   compresses photos client-side before upload to reduce bandwidth.
//
// DESIGN PATTERNS:
//   - Builder Pattern (dynamic HTML form construction)
//   - Observer Pattern (input change listeners for dirty tracking)
...
//   before innerHTML insertion to prevent XSS injection attacks.
// ============================================
